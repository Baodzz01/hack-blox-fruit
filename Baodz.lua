--[[
    Project: BaodzHub (Blox Fruits Edition - Ultimate Customization)
    Author: MrDon
]]
...
getgenv().BaodzHub = getgenv().BaodzHub or {
    ...
    AimbotFOV = 180,
    AutoFarm = false,
    SelectedMob = "Bandit", -- Default target mob name
    HitboxSize = 25
}
...
-- Common Blox Fruits Mobs to cycle through on click
local mobList = {"Bandit", "Monkey", "Gorilla", "Pirate", "Brute", "Swan Pirate", "Factory Staff"}
local mobIndex = 1
...
RunService.RenderStepped:Connect(function()
    pcall(function()
        ...
        -- Auto Farm (Target Specific Mob, Fly/Teleport to it, Equips Tool, Attacks)
        if Config.AutoFarm and hrp and enemiesFolder then
            for _, mob in ipairs(enemiesFolder:GetChildren()) do
                ...
                if mHrp and mHum and mHum.Health > 0 and mob.Name == Config.SelectedMob then
                    hrp.CFrame = mHrp.CFrame * CFrame.new(0, 4, 0)
